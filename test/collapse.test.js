  ...
  it('接受 selected 属性', (done) => {
    ...
    div.innerHTML = `
        <s-collapse :selected="xxx">
          <s-collapse-item title="标题1" name="1"><span id="content-1">1</span></s-collapse-item>
          <s-collapse-item title="标题2" name="2"><span id="content-2">2</span></s-collapse-item>
          <s-collapse-item title="标题3" name="3"><span id="content-3">3</span></s-collapse-item>
        </s-collapse>
    `
    const vm = new Vue({
      el: div,
